...
namespace tyuiu.cources.programming.interfaces.Sprint2
{
    ...
    public interface ISprint2Task6V8 { string FindDateOfPreviousDay(int m, int n); }
    public interface ISprint2Task6V9 { string FindDateOfNextDay(int m, int n); }
    public interface ISprint2Task6V10 { string FindDateOfPreviousDay(int g, int m, int n); }
    public interface ISprint2Task6V11 { string FindDateOfNextDay(int g, int m, int n); }
    ...
    public interface ISprint2Task6V14 { string FindDayName(int value); }
    public interface ISprint2Task6V15 { string FindDayName(int value); }
