...
namespace tyuiu.cources.programming
{
    public class TestingDataController
    {
        private Dictionary<Type, (object result, object[] args)> testData = new()
        {
            ...
            { typeof(ISprint1Task7V18), (1.913, new object[] {1, 1 })},
            ...
            { typeof(ISprint3Task0V1),  (1935.0, new object[] {4.0, 1, 15})},
            { typeof(ISprint3Task0V2),  (0.021, new object[] {1, 9})},
            { typeof(ISprint3Task0V3),  (0.353, new object[] {1, 10})},
            { typeof(ISprint3Task0V4),  (6482.439, new object[] {1, 7})},
            { typeof(ISprint3Task0V5),  (81.083, new object[] {1, 10})},
            { typeof(ISprint3Task0V6),  (0.001, new object[] {1, 15})},
            { typeof(ISprint3Task0V7),  (0.333, new object[] {0.75, 1, 20})},
            { typeof(ISprint3Task0V8),  (0.019, new object[] {0.25, 1, 10})},
            { typeof(ISprint3Task0V9),  (0.430, new object[] {0.5, 1, 15})},
            { typeof(ISprint3Task0V10),  (0.033, new object[] {5.0, 1, 5})},
            { typeof(ISprint3Task0V11),  (0.042, new object[] {5.0, 1, 10})},
            { typeof(ISprint3Task0V12),  (7.500, new object[] {1.0, 1, 13})},
            { typeof(ISprint3Task0V13),  (0.298, new object[] {0.5, 1, 20})},
            { typeof(ISprint3Task0V14),  (14400, new object[] {2.0, 1, 5})},
            { typeof(ISprint3Task0V15),  (4.063, new object[] {0.7, 1, 10})},
            { typeof(ISprint3Task0V16),  (13824, new object[] {1, 11})},
            { typeof(ISprint3Task0V17),  (-0.709, new object[] {1, 10})},
            { typeof(ISprint3Task0V18),  (914700.940, new object[] {1.0, 1, 6})},
            { typeof(ISprint3Task0V19),  (4.399, new object[] {1, 10})},
            { typeof(ISprint3Task0V20),  (287.180, new object[] {1.0, 1, 14})},
            { typeof(ISprint3Task0V21),  (-63.727, new object[] {1.5, 1, 13})},
            { typeof(ISprint3Task0V22),  (55217.446, new object[] {0.25, 1, 8})},
            { typeof(ISprint3Task0V23),  (0.298, new object[] {1.5, 1, 10})},
            { typeof(ISprint3Task0V24),  (0.125, new object[] {5.0, 1, 7})},
            { typeof(ISprint3Task0V25),  (0.690, new object[] {5.0, 1, 14})},
            { typeof(ISprint3Task0V26),  (-15.642, new object[] {1, 9})},
            { typeof(ISprint3Task0V27),  (16.016, new object[] {5.0, 1, 13})},
            { typeof(ISprint3Task0V28),  (411589.537, new object[] {0.25, 1, 17})},
            { typeof(ISprint3Task0V29),  (2.065, new object[] {0.5, 1, 10})},
            { typeof(ISprint3Task0V30),  (2477.158, new object[] {1, 20})},

            //Task1

            { typeof(ISprint3Task1V1), (5.311, new object[] {1, 7})},
            { typeof(ISprint3Task1V2), (0.968, new object[] {1, 15})},
            { typeof(ISprint3Task1V3), (24589.408, new object[] {1, 10})},
            { typeof(ISprint3Task1V4), (1.550, new object[] {1, 10})},
            { typeof(ISprint3Task1V5), (3.195, new object[] {1, 10})},
            { typeof(ISprint3Task1V6), (-389102.25, new object[] {4.0, 1, 10})},
            { typeof(ISprint3Task1V7), (-0.930, new object[] {0.25, 1, 9})},
            { typeof(ISprint3Task1V8), (2539.225, new object[] {0.25, 1, 15})},
            { typeof(ISprint3Task1V9), (5815.752, new object[] {5.0, 1, 4})},
            { typeof(ISprint3Task1V10), (0.168, new object[] {5.0, 1, 17})},
            { typeof(ISprint3Task1V11), (0.005, new object[] {0.75, 1, 14})},
            { typeof(ISprint3Task1V12), (1.001, new object[] {5.0, 1, 10})},
            { typeof(ISprint3Task1V13), (164.845, new object[] {1.2, 1, 7})},
            { typeof(ISprint3Task1V14), (3.546, new object[] {0.7, 1, 14})},
            { typeof(ISprint3Task1V15), (208845.0, new object[] {2.0, 1, 5})},
            { typeof(ISprint3Task1V16), (15.948, new object[] {0.7, 1, 15})},
            { typeof(ISprint3Task1V17), (482982.891, new object[] {1.0, 1, 4})},
            { typeof(ISprint3Task1V18), (0.121, new object[] {1, 15})},
            { typeof(ISprint3Task1V19), (94.895, new object[] {1.0, 1, 9})},
            { typeof(ISprint3Task1V20), (51191.405, new object[] {1, 16})},
            { typeof(ISprint3Task1V21), (99.512, new object[] {1.0, 1, 12})},
            { typeof(ISprint3Task1V22), (3550.571, new object[] {1.5, 1, 20})},
            { typeof(ISprint3Task1V23), (0.071, new object[] {5.0, 1, 5})},
            { typeof(ISprint3Task1V24), (0.186, new object[] {5.0, 1, 12})},
            { typeof(ISprint3Task1V25), (844.664, new object[] {2.0, 1, 6})},
            { typeof(ISprint3Task1V26), (1.5, new object[] {5.0, 1, 8})},
            { typeof(ISprint3Task1V27), (419028.1, new object[] {0.75, 1, 5})},
            { typeof(ISprint3Task1V28), (-0.186, new object[] {0.5, 1, 18})},
            { typeof(ISprint3Task1V29), (13051.34, new object[] {0.25, 1, 11})},
            { typeof(ISprint3Task1V30), (3.589, new object[] {0.5, 1, 12})},

            //Task2

            { typeof(ISprint3Task2V1), (0.353, new object[] {1, 10})},
            { typeof(ISprint3Task2V2), (6482.439, new object[] {1, 7})},
            { typeof(ISprint3Task2V3), (1935.0, new object[] {4.0, 1, 15})},
            { typeof(ISprint3Task2V4), (0.021, new object[] {1, 9})},
            { typeof(ISprint3Task2V5), (0.333, new object[] {0.75, 1, 20})},
            { typeof(ISprint3Task2V6), (0.019, new object[] {0.25, 1, 10})},
            { typeof(ISprint3Task2V7), (81.083, new object[] {1, 10})},
            { typeof(ISprint3Task2V8), (0.001, new object[] {1, 15})},
            { typeof(ISprint3Task2V9), (0.042, new object[] {5.0, 1, 10})},
            { typeof(ISprint3Task2V10), (7.500, new object[] {1.0, 1, 13})},
            { typeof(ISprint3Task2V11), (0.430, new object[] {0.5, 1, 15})},
            { typeof(ISprint3Task2V12), (0.033, new object[] {5.0, 1, 5})},
            { typeof(ISprint3Task2V13), (4.063, new object[] {0.7, 1, 10})},
            { typeof(ISprint3Task2V14), (13824.0, new object[] {1, 11})},
            { typeof(ISprint3Task2V15), (0.298, new object[] {0.5, 1, 20})},
            { typeof(ISprint3Task2V16), (14400.0, new object[] {2.0, 1, 5})},
            { typeof(ISprint3Task2V17), (4.399, new object[] {1, 10})},
            { typeof(ISprint3Task2V18), (287.180, new object[] {1.0, 1, 14})},
            { typeof(ISprint3Task2V19), (-0.709, new object[] {1, 10})},
            { typeof(ISprint3Task2V20), (914700.940, new object[] {1.0, 1, 6})},
            { typeof(ISprint3Task2V21), (0.298, new object[] {1.5, 1, 10})},
            { typeof(ISprint3Task2V22), (0.125, new object[] {5.0, 1, 7})},
            { typeof(ISprint3Task2V23), (-63.727, new object[] {1.5, 1, 13})},
            { typeof(ISprint3Task2V24), (55217.446, new object[] {0.25, 1, 8})},
            { typeof(ISprint3Task2V25), (16.016, new object[] {5.0, 1, 13})},
            { typeof(ISprint3Task2V26), (411589.537, new object[] {0.25, 1, 17})},
            { typeof(ISprint3Task2V27), (0.690, new object[] {5.0, 1, 14})},
            { typeof(ISprint3Task2V28), (-15.642, new object[] {1, 9})},
            { typeof(ISprint3Task2V29), (-0.186, new object[] {0.5, 1, 18})},
            { typeof(ISprint3Task2V30), (13051.34, new object[] {0.25, 1, 11})},
            ...
            { typeof(ISprint3Task3V5), ("fif* *l f*ll", new object[] { "fifa al fall", 'a', '*'})},
            { typeof(ISprint3Task3V6), ("ttable to stgh", new object[] { "12able 1o s4gh", 't'})},
            { typeof(ISprint3Task3V7), ("4ft h44t nt4", new object[] { "gft hggt ntg", 'g','4'})},
            { typeof(ISprint3Task3V8), (12, new object[] {"vc,x12fc fc!e"})},
            { typeof(ISprint3Task3V9), ("wwhy vfewrw vfwwb", new object[] {"56hy vfe4r4 vf45b",'w'})},
            { typeof(ISprint3Task3V10), ("gdff vft ", new object[] {"gdfppf vfppt p",'p'})},
            { typeof(ISprint3Task3V11), ("s7wre7 v7w77 7", new object[] { "sqwreq vqwqq q", 'q', '7'})},
            { typeof(ISprint3Task3V12), (3, new object[] { "bkkrk ckkkcs ksr", 'k'})},
            { typeof(ISprint3Task3V13), (5, new object[] {"?sd!! 5gh. s!"})},
            { typeof(ISprint3Task3V14), ("'gt ghe'' be'", new object[] { "dgt ghedd bed", 'd','\''})},
            { typeof(ISprint3Task3V15), (1, new object[] {"lrmmse mg sermmmrt", 'm'})},
            { typeof(ISprint3Task3V16), (6, new object[] {"ice nice ice creamcc", 'c'})},
            { typeof(ISprint3Task3V17), (98, new object[] {"*vn98n! b,"})},
            { typeof(ISprint3Task3V18), ("nnnnvf nn bgy", new object[] {"4n5nvf 56 bgy", 'n'})},
            { typeof(ISprint3Task3V19), ("s22rrg 2 vfr2", new object[] {"sxxrrg x vfrx", 'x', '2'})},
            { typeof(ISprint3Task3V20), (5, new object[] {"gfft ntf f opf",'f'})},
            { typeof(ISprint3Task3V21), ("fegeht gej eekge", new object[] {"f3g5ht g4j 34kg4", 'e'})},
            { typeof(ISprint3Task3V22), (3, new object[] {"tbtbbb dsfbg bbg", 'b'})},
            { typeof(ISprint3Task3V23), ("fd88t 8iu v8r8", new object[] {"fdsst siu vsrs", 's', '8'})},
            { typeof(ISprint3Task3V24), ("*ft h**t nt*", new object[] {"gft hggt ntg", 'g', '*'})},
            { typeof(ISprint3Task3V25), (1, new object[] {"kjhgfuu gujut dtuu", 'u'})},
            { typeof(ISprint3Task3V26), (3, new object[] {"have a nice time", 'e'})},
            { typeof(ISprint3Task3V27), (567, new object[] {"!bt, g567kid f!"})},
            { typeof(ISprint3Task3V28), ("frrhyt trj rgkgrr", new object[] {"f35hyt t4j 3gkg45", 'r'})},
            { typeof(ISprint3Task3V29), ("cgr vtg nt", new object[] {"chgr vhhtg hnht", 'h'})},
            { typeof(ISprint3Task3V30), (4, new object[] {"fyyklbtyn ygrc vfyyyyh", 'y'})},

            //Task4

            { typeof(ISprint3Task4V1), (0.962, new object[] {-5, 5})},
            { typeof(ISprint3Task4V2), (0.104, new object[] {-5, 5})},
            { typeof(ISprint3Task4V3), (1.067, new object[] {-5, 5})},
            { typeof(ISprint3Task4V4), (-35.317, new object[] {-5, 5})},
            { typeof(ISprint3Task4V5), (-0.858, new object[] {-5, 5})},
            { typeof(ISprint3Task4V6), (8.995, new object[] {-5, 5})},
            { typeof(ISprint3Task4V7), (1231.499, new object[] {-5, 5})},
            { typeof(ISprint3Task4V8), (2237.227, new object[] {-5, 5})},
            { typeof(ISprint3Task4V9), (1.708, new object[] {-5, 5})},
            { typeof(ISprint3Task4V10), (0.014, new object[] {-5, 5})},
            { typeof(ISprint3Task4V11), (0.84, new object[] {-5, 5})},
            { typeof(ISprint3Task4V12), (467.59, new object[] {-5, 5})},
            { typeof(ISprint3Task4V13), (1.899, new object[] {-5, 5})},
            { typeof(ISprint3Task4V14), (6.263, new object[] {-5, 5})},
            { typeof(ISprint3Task4V15), (623.499, new object[] {-5, 5})},
            { typeof(ISprint3Task4V16), (6.719, new object[] {-5, 5})},
            { typeof(ISprint3Task4V17), (0.527, new object[] {-5, 5})},
            { typeof(ISprint3Task4V18), (2.993, new object[] {-5, 5})},
            { typeof(ISprint3Task4V19), (9.432, new object[] {-5, 5})},
            { typeof(ISprint3Task4V20), (10.483, new object[] {-5, 5})},
            { typeof(ISprint3Task4V21), (0.586, new object[] {-5, 5})},
            { typeof(ISprint3Task4V22), (73.346, new object[] {-5, 5})},
            { typeof(ISprint3Task4V23), (244.656, new object[] {-5, 5})},
            { typeof(ISprint3Task4V24), (46.75, new object[] {-5, 5})},
            { typeof(ISprint3Task4V25), (8.995, new object[] {-5, 5})},
            ...
            { typeof(ISprint3Task5V1), (6.3, new object[] {5, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V2), (35.658, new object[] {5, 1, 1, 3, 12})},
            { typeof(ISprint3Task5V3), (33.247, new object[] {5, 1, 1, 3, 11})},
            { typeof(ISprint3Task5V4), (3328.185, new object[] {5, 1, 1, 3, 13})},
            { typeof(ISprint3Task5V5), (91.031, new object[] {5, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V6), (40.917, new object[] {1, 1, 3, 10})},
            { typeof(ISprint3Task5V7), (130.917, new object[] {1, 1, 3, 10})},
            { typeof(ISprint3Task5V8), (119.066, new object[] {5, 1, 1, 3, 12})},
            { typeof(ISprint3Task5V9), (231.235, new object[] {5, 1, 1, 3, 14})},
            { typeof(ISprint3Task5V10), (20685.0, new object[] {5, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V11), (64.234, new object[] {5, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V12), (55.748, new object[] {5, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V13), (118.212, new object[] {5, 1, 1, 3, 12})},
            { typeof(ISprint3Task5V14), (-31.275, new object[] {5, 1, 1, 3, 14})},
            { typeof(ISprint3Task5V15), (548.732, new object[] {5, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V16), (745.748, new object[] {2, 1, 1,3,10})},
            { typeof(ISprint3Task5V17), (899.624, new object[] {2, 1, 1, 3, 12})},
            { typeof(ISprint3Task5V18), (768.361, new object[] {5, 1, 1, 3, 11})},
            { typeof(ISprint3Task5V19), (30598.002, new object[] {2, 1, 1, 3, 6})},
            { typeof(ISprint3Task5V20), (50584.322, new object[] {5, 1, 1,3,6})},
            { typeof(ISprint3Task5V21), (25.981, new object[] {2, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V22), (68.991, new object[] {2, 1, 1, 3, 12})},
            { typeof(ISprint3Task5V23), (-3653.176, new object[] {2, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V24), (-12926.893, new object[] {2, 1, 1, 3, 12})},
            { typeof(ISprint3Task5V25), (6133.748, new object[] {2, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V26), (49146.884, new object[] {2, 1, 1, 3, 13})},
            { typeof(ISprint3Task5V27), (-1495.954, new object[] {2, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V28), (-1032.182, new object[] {2, 1, 1, 3, 12})},
            { typeof(ISprint3Task5V29), (36.279, new object[] {2, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V30), (132.0, new object[] {2, 1, 1, 3, 11})},
            ...
            { typeof(ISprint3Task7V1), (new object[11] {-12.18, 16.03, 18.87, 4.96, -9.99, -2.0, 2.16, -7.54, -22.76, -20.45, 7.77}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V2), (new object[11] {59.49, 38.47, -2.81, -19.67, -8.42, 0.57, -6.3, -20.14, -3.51, 38.13, 59.6}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V3), (new object[11] {4.34, 4.16, 3.71, 3.27, 2.93, 2.5, 0.71, -47.61, 55.15, 45.17, 14.97}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V4), (new object[11] {-2.15, -2.57, -3.0, -3.83, -11.7, 3.0, 2.19, 3.31, 2.97, 1.18, 0.03}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V5), (new object[11] {70.14, 55.21, 41.05, 27.96, 15.48, 1.0, -13.06, -28.16, -42.96, -56.77, -69.83}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V6), (new object[11] {23.92, 18.88, 13.1, 7.24, 1.8, -8.0, -5.7, -11.26, -17.12, -22.88, -27.92}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V7), (new object[11] {15.19, 11.67, 9.0, 0.0, 4.08, 1.5, -2.28, -6.52, -10.19, -12.76, -14.68}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V8), (new object[11] {-8.86, -7.19, -6.14, -4.76, -2.33, 1, 4.38, 0.0, 6.13, 7.07, 8.61}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V9), (new object[11] {-27.22, -22.25, -16.66, -11.04, -6.13, -3.0, 4.84, 8.86, 14.43, 20.18, 25.24}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V10), (new object[11] {-15.4, -13.31, -11.36, -8.0, -2.62, 1.83, 4.49, 6.78, 10.58, 17.38, 23.76}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V11), (new object[11] {20.36, 15.42, 10.99, 7.43, 4.33, 1.0, 0.0, -8.87, -13.03, -16.53, -19.6}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V12), (new object[11] {6.49, -9.88, -12.26, -4.6, 0.52, 4.0, -0.75, 4.55, 12.23, 9.86, -6.5}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V13), (new object[11] {-9.1, 1.55, 292.78, -0.57, -0.35, 2.0, 4.35, 4.57, -288.78, 2.45, 13.1}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V14), (new object[11] {-8.38, -6.88, -1.85, 47.13, 12.92, -3.0, -2.54, -1.57, -2.38, -24.78, -213.11}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V15), (new object[11] {3.63, -11.7, -14.02, -5.24, 1.32, 0.0, -1.32, 5.24, 14.02, 11.7, -3.63}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V16), (new object[11] {-36.41, -22.07, 5.68, 16.72, 8.35, -0.5, 9.63, 16.29, 5.01, -22.4, -36.3}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V17), (new object[11] {-0.62, -16.79, -17.77, -6.3, -5.04, -6.0, -7.85, -2.43, 5.91, 4.33, -11.82}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V18), (new object[11] {7.76, 7.36, 7.26, 7.9, 15.88, 2.0, 4.35, 5.63, 6.49, 6.49, 6.32}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V19), (new object[11] {23.61, 16.08, 7.84, 4.58, 2.88, 0.75, -4.47, -9.46, -7.41, -6.16, -7.29}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V20), (new object[11] {17.27, 14.08, 10.27, 6.65, 3.87, 2.0, -0.74, -3.71, -7.59, -11.55, -14.74}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V21), (new object[11] {28.05, 22.27, 17.01, 12.35, 7.51, 0.0, 1.62, -7.03, -12.99, -17.55, -21.43}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V22), (new object[11] {8.04, 6.68, 4.84, 1.76, 0.45, 0.5, -0.87, -2.42, -3.88, -6.83, -8.88}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V23), (new object[11] {13.81, 11.87, 9.87, 7.74, 5.36, 2.5, 0.0, 0.79, -1.75, -3.78, -5.71}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V24), (new object[11] {7.83, 6.22, 6.36, 6.96, -0.52, 0.0, -3.3, -5.53, -6.25, -6.63, -8.24}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V25), (new object[11] {4.67, 0.43, -8.26, -9.87, -3.98, 1.0, 0.02, -1.87, 3.74, 16.43, 24.67}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V26), (new object[11] {19.81, 16.79, 13.87, 10.98, 7.94, 3.0, 3.23, -0.45, -3.79, -6.97, -10.0}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V27), (new object[11] {-15.44, -10.93, -7.22, -5.04, 0.0, -0.3, 2.57, 6.4, 10.04, 12.72, 14.68}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V28), (new object[11] {-11.22, -8.65, -4.76, -6.47, -2.98, 1.0, 1.82, 3.55, 6.99, 7.74, 9.03}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V29), (new object[11] {-32.26, -27.5, -22.8, -17.95, -12.97, -9.0, -0.31, 3.77, 8.57, 13.42, 18.28}, new object[] {-5, 5})},
            { typeof(ISprint3Task7V30), (new object[11] {-15.6, -12.35, -10.72, -8.88, -2.16, 3.25, 6.64, 10.3, 16.17, 28.1, 38.41}, new object[] {-5, 5})},
