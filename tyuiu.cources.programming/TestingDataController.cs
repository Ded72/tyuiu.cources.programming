...
namespace tyuiu.cources.programming
{
    public class TestingDataController
    {
        private Dictionary<Type, (object result, object[] args)> testData = new()
        {
            ...
            { typeof(ISprint3Task0V1),  (1935.0, new object[] {4, 1, 15})},
            ...
            { typeof(ISprint3Task0V10),  (0.033, new object[] {5, 1, 5})},
            { typeof(ISprint3Task0V11),  (0.042, new object[] {5, 1, 10})},
            { typeof(ISprint3Task0V12),  (7.500, new object[] {1, 1, 13})},
            { typeof(ISprint3Task0V13),  (0.298, new object[] {0.5, 1, 20})},
            { typeof(ISprint3Task0V14),  (14400.0, new object[] {2, 1, 5})},
            { typeof(ISprint3Task0V15),  (4.063, new object[] {0.7, 1, 10})},
            { typeof(ISprint3Task0V16),  (13824.0, new object[] {1, 11})},
            { typeof(ISprint3Task0V17),  (-0.709, new object[] {1, 10})},
            { typeof(ISprint3Task0V18),  (914700.940, new object[] {1, 1, 6})},
            { typeof(ISprint3Task0V19),  (4.399, new object[] {1, 10})},
            { typeof(ISprint3Task0V20),  (287.180, new object[] {1, 1, 14})},
            ...
            { typeof(ISprint3Task0V24),  (0.125, new object[] {5, 1, 7})},
            { typeof(ISprint3Task0V25),  (0.690, new object[] {5, 1, 14})},
            { typeof(ISprint3Task0V26),  (-15.642, new object[] {1, 9})},
            { typeof(ISprint3Task0V27),  (16.016, new object[] {5, 1, 13})},
            ...
            { typeof(ISprint3Task1V6), (-389102.25, new object[] {4, 1, 10})},
            { typeof(ISprint3Task1V7), (-0.930, new object[] {0.25, 1, 9})},
            { typeof(ISprint3Task1V8), (2539.225, new object[] {0.25, 1, 15})},
            { typeof(ISprint3Task1V9), (5815.752, new object[] {5, 1, 4})},
            { typeof(ISprint3Task1V10), (0.168, new object[] {5, 1, 17})},
            { typeof(ISprint3Task1V11), (0.005, new object[] {0.75, 1, 14})},
            { typeof(ISprint3Task1V12), (1.001, new object[] {5, 1, 10})},
            { typeof(ISprint3Task1V13), (164.845, new object[] {1.2, 1, 7})},
            { typeof(ISprint3Task1V14), (3.546, new object[] {0.7, 1, 14})},
            { typeof(ISprint3Task1V15), (208845.0, new object[] {2, 1, 5})},
            { typeof(ISprint3Task1V16), (15.948, new object[] {0.7, 1, 15})},
            { typeof(ISprint3Task1V17), (482982.891, new object[] {1, 1, 4})},
            { typeof(ISprint3Task1V18), (0.121, new object[] {1, 15})},
            { typeof(ISprint3Task1V19), (94.895, new object[] {1, 1, 9})},
            { typeof(ISprint3Task1V20), (51191.405, new object[] {1, 16})},
            { typeof(ISprint3Task1V21), (99.512, new object[] {1, 1, 12})},
            { typeof(ISprint3Task1V22), (3550.571, new object[] {1.5, 1, 20})},
            { typeof(ISprint3Task1V23), (0.071, new object[] {5, 1, 5})},
            { typeof(ISprint3Task1V24), (0.186, new object[] {5, 1, 12})},
            { typeof(ISprint3Task1V25), (844.664, new object[] {2, 1, 6})},
            { typeof(ISprint3Task1V26), (1.5, new object[] {5, 1, 8})},
