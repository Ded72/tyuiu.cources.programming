...
namespace tyuiu.cources.programming
{
    public class TestingDataController
    {
        private Dictionary<Type, (object result, object[] args)> testData = new()
        {
            ...
            { typeof(ISprint3Task2V3), (1935.0, new object[] {4, 1, 15})},
            ...
            { typeof(ISprint3Task2V9), (0.042, new object[] {5, 1, 10})},
            { typeof(ISprint3Task2V10), (7.500, new object[] {1, 1, 13})},
            { typeof(ISprint3Task2V11), (0.430, new object[] {0.5, 1, 15})},
            { typeof(ISprint3Task2V12), (0.033, new object[] {5, 1, 5})},
