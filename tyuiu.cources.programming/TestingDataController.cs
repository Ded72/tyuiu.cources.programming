...
namespace tyuiu.cources.programming
{
    public class TestingDataController
    {
        private Dictionary<Type, (object result, object[] args)> testData = new()
        {
            ...
            { typeof(ISprint3Task4V25), (-44.313, new object[] {-5, 5})},
            ...
            { typeof(ISprint3Task5V1), (12.599, new object[] {5, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V2), (71.317, new object[] {5, 1, 1, 3, 12})},
            { typeof(ISprint3Task5V3), (66.493, new object[] {5, 1, 1, 3, 11})},
            { typeof(ISprint3Task5V4), (6656.369, new object[] {5, 1, 1, 3, 13})},
            { typeof(ISprint3Task5V5), (196.572, new object[] {5, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V6), (81.833, new object[] {1, 1, 3, 10})},
            { typeof(ISprint3Task5V7), (261.833, new object[] {1, 1, 3, 10})},
            { typeof(ISprint3Task5V8), (238.132, new object[] {5, 1, 1, 3, 12})},
            { typeof(ISprint3Task5V9), (462.469, new object[] {5, 1, 1, 3, 14})},
            { typeof(ISprint3Task5V10), (41370.0, new object[] {5, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V11), (128.467, new object[] {5, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V12), (111.495, new object[] {5, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V13), (236.424, new object[] {5, 1, 1, 3, 12})},
            { typeof(ISprint3Task5V14), (-62.55, new object[] {5, 1, 1, 3, 14})},
            { typeof(ISprint3Task5V15), (1097.465, new object[] {5, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V16), (231.495, new object[] {2, 1, 1,3,10})},
            { typeof(ISprint3Task5V17), (287.248, new object[] {2, 1, 1, 3, 12})},
            { typeof(ISprint3Task5V18), (1536.722, new object[] {5, 1, 1, 3, 11})},
            { typeof(ISprint3Task5V19), (61196.004, new object[] {2, 1, 1, 3, 6})},
            { typeof(ISprint3Task5V20), (101168.643, new object[] {5, 1, 1,3,6})},
            { typeof(ISprint3Task5V21), (51.963, new object[] {2, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V22), (137.982, new object[] {2, 1, 1, 3, 12})},
            { typeof(ISprint3Task5V23), (-7306.353, new object[] {2, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V24), (-25853.785, new object[] {2, 1, 1, 3, 12})},
            { typeof(ISprint3Task5V25), (12267.495, new object[] {2, 1, 1, 3, 10})},
            { typeof(ISprint3Task5V26), (98293.769, new object[] {2, 1, 1, 3, 13})},
            { typeof(ISprint3Task5V27), (-2991.907, new object[] {2, 1, 1, 3, 10})},
