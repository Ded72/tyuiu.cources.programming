...
namespace tyuiu.cources.programming
{
    public class TestingDataController
    {
        private Dictionary<Type, (object result, object[] args)> testData = new()
        {
            ...
            { typeof(ISprint3Task0V5),  (81.083, new object[] {})},
            { typeof(ISprint3Task0V6),  (-389102.25, new object[] {4.0})},
            ...
            { typeof(ISprint3Task0V10),  (0.168, new object[] {5.0})},
            { typeof(ISprint3Task0V11),  (0.042, new object[] {5.0})},
            { typeof(ISprint3Task0V12),  (1.001, new object[] {5.0})},
            ...
            { typeof(ISprint3Task0V24),  (0.186, new object[] {5.0})},
            { typeof(ISprint3Task0V25),  (0.690, new object[] {5.0})},
            { typeof(ISprint3Task0V26),  (1.5, new object[] {5.0})},
            { typeof(ISprint3Task0V27),  (16.016, new object[] {5.0})},
