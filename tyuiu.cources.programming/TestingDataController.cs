...
namespace tyuiu.cources.programming
{
    public class TestingDataController
    {
        private Dictionary<Type, (object result, object[] args)> testData = new()
        {
            ...
            { typeof(ISprint3Task4V1), (151, new object[] {11, 17})},
            { typeof(ISprint3Task4V2), (29, new object[] {12, 18})},
            { typeof(ISprint3Task4V3), (121, new object[] {13, 19})},
            { typeof(ISprint3Task4V4), (8, new object[] {14, 20})},
            { typeof(ISprint3Task4V5), (242, new object[] {15, 22})},
            { typeof(ISprint3Task4V6), (11, new object[] {16, 24})},
            { typeof(ISprint3Task4V7), (344, new object[] {17, 26})},
            { typeof(ISprint3Task4V8), (292, new object[] {18, 28})},
            { typeof(ISprint3Task4V9), (53, new object[] {19, 30})},
            { typeof(ISprint3Task4V10), (396, new object[] {20, 32})},
            { typeof(ISprint3Task4V11), (9, new object[] {10, 19})},
            { typeof(ISprint3Task4V12), (221, new object[] {9, 18})},
            { typeof(ISprint3Task4V13), (117, new object[] {8, 17})},
            { typeof(ISprint3Task4V14), (13, new object[] {7, 16})},
            { typeof(ISprint3Task4V15), (168, new object[] {6, 15})},
            { typeof(ISprint3Task4V16), (42, new object[] {5, 16})},
            { typeof(ISprint3Task4V17), (43, new object[] {10, 20})},
            { typeof(ISprint3Task4V18), (95, new object[] {9, 18})},
            { typeof(ISprint3Task4V19), (16, new object[] {10, 15})},
            { typeof(ISprint3Task4V20), (41, new object[] {20, 32})},
            { typeof(ISprint3Task4V21), (485, new object[] {19, 30})},
            { typeof(ISprint3Task4V22), (55, new object[] {19, 31})},
            { typeof(ISprint3Task4V23), (34, new object[] {18, 28})},
            { typeof(ISprint3Task4V24), (41, new object[] {17, 26})},
            { typeof(ISprint3Task4V25), (89, new object[] {16, 24})},
            { typeof(ISprint3Task4V26), (33, new object[] {15, 22})},
            { typeof(ISprint3Task4V27), (129, new object[] {14, 20})},
            { typeof(ISprint3Task4V28), (15, new object[] {13, 19})},
            { typeof(ISprint3Task4V29), (178, new object[] {12, 18})},
            { typeof(ISprint3Task4V30), (25, new object[] {11, 17})},
